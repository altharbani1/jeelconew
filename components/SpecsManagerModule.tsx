...
const DEFAULT_SPECS_DB: SpecsDatabase = {
  ...
  doors: ['أوتوماتيكية بالكامل (Center Opening)', 'أوتوماتيكية بالكامل (Telescopic)', 'نصف أوتوماتيك (Semi-Auto)', 'أبواب يدوية (Manual)', 'أبواب سيلكوم إيطالي فل أوتوماتيك'],
  externalDoors: ['أوتوماتيكية بالكامل (Center Opening)', 'أوتوماتيكية بالكامل (Telescopic)', 'نصف أوتوماتيك (Semi-Auto)', 'أبواب يدوية (Manual)', 'أبواب سيلكوم إيطالي فل أوتوماتيك'],
...
const LABELS: Record<keyof TechnicalSpecs, string> = {
  ...
  cabin: 'الكابينة',
  doors: 'الأبواب الداخلية',
  externalDoors: 'الأبواب الخارجية',
